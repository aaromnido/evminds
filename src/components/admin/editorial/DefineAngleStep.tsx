...
export default function DefineAngleStep({ idea }: Props) {
  ...
  /**
   * Creates the durable piece and moves on.
   *
   ...
   *
   * PROTOTYPE: the text itself is still generated by `editorial-mocks.ts` on the
   * next screen. What is real here is the row.
   */
  async function handleGenerate() {
    ...
    try {
      ...
      const params = new URLSearchParams({ canales: channels.join(","), pieza: data.id });
